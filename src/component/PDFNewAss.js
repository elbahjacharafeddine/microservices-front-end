    ...
    <img class="img-responsive" alt="iamgurdeeposahan" src="https://seeklogo.com/images/T/tasshilat-logo-EF4B36438D-seeklogo.com.png" style={{width: "200px",borderRadius:"75px"}} />
            ...
            <div>
                    <div class="d-flex justify-content-center text-center">
							...
							<h1>Receipt for Issurance service</h1>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-6"><b>Payment for {props.facture.mounth} / {props.facture.year}</b></td>
                            <td class="col-md-6"><i class="fa fa-inr"></i> {props.facture.montant} Dh</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="col-md-6">
                                <ul>
                                <li><b>matricule</b> : {props.facture.client.matricule}<br/></li>
                                <li><b>full name</b> : {props.facture.client.nom + " "+props.facture.client.prenom}<br/></li>
                                <li><b>tele</b> : {props.facture.client.telephone}<br/></li>
                                <li><b>email</b> : {props.facture.client.email}<br/></li>
                                <li><b>address</b> : {props.facture.client.adress}</li>
                                </ul> </td>
                        </tr>
                        
                        <tr>
                            <td class="text-right col-md-6"><h2><strong>Total: </strong></h2></td>
                            <td class="text-left text-danger col-md-6"><h2><strong><i class="fa fa-inr"></i> {props.facture.montant} Dh</strong></h2></td>
                        </tr>
                    </tbody>
                </table>
            </div>
				...
				<div class="receipt-header receipt-header-mid receipt-footer">
					<div >
						<div class="receipt-center d-flex justify-content-center">
							<p><b>Date :</b> {props.facture.datePayement}</p>
						</div>
					</div>
