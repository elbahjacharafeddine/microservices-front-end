            ...
            <div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="col-md-6"><b>Facture information : </b></td>
                        </tr>
                        <tr>
                            <td class="col-md-6">
                                <ul>
                                <li><b>Type</b> : {props.facture.type}<br/></li>
                                <li><b>matricule</b> : {props.facture.metricule}<br/></li>
                                <li><b>Start Date</b> : {props.facture.dateDebut}</li>
                                <li><b>End Date</b> : {props.facture.dateFin}</li>
                                <li><b>State</b> : valide</li>
                                </ul> </td>
                        </tr>
