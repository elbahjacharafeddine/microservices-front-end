    ...
    <img class="img-responsive" alt="iamgurdeeposahan" src="https://seeklogo.com/images/T/tasshilat-logo-EF4B36438D-seeklogo.com.png" style={{width: "200px",borderRadius:"75px"}} />
            ...
            <div>
                    <div class="d-flex justify-content-center text-center">
							...
							<h1>Receipt for {props.facture.type} service</h1>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td class="col-md-6"><b>Payment for {props.facture.month} / {props.facture.year}</b></td>
                        ...
                        <tr>
                            <td class="col-md-6">
                                ...
                                <li><b>full name</b> : {props.facture.client.lastName + " "+props.facture.client.firstName}<br/></li>
                                <li><b>tele</b> : {props.facture.client.tele}<br/></li>
                                <li><b>email</b> : {props.facture.client.email}<br/></li>
                                <li><b>address</b> : {props.facture.client.address}</li>
                                </ul> </td>
                        </tr>
