...
const loadLineChart = async()=>{
  axios({
      ...
      url: "http://192.168.48.82:8080/water/statistics/line chart/"+lineChartYear,
      method: "GET",
      })
...
const loadDonutChart = async()=>{
  axios({
      // Endpoint to send files
      url: "http://192.168.48.82:8080/water/statistics/donut chart",
      method: "GET",
      })
      // Handle the response from backend here
      .then((res) => {
...
const loadBarChart = async()=>{
  axios({
      // Endpoint to send files
      url: "http://192.168.48.82:8080/water/statistics/bar chart/"+barChartYear,
      method: "GET",
      })
      // Handle the response from backend here
      .then((res) => {
...
const handleChangeBar = (newValue)=>{
  ...
  axios({
    // Endpoint to send files
    url: "http://192.168.48.82:8080/water/statistics/bar chart/"+newValue,
    method: "GET",
    })
    // Handle the response from backend here
    .then((res) => {
...
const handleChangeLine = (newValue)=>{
  ...
  axios({
    // Endpoint to send files
    url: "http://192.168.48.82:8080/water/statistics/line chart/"+newValue,
    method: "GET",
    })
    // Handle the response from backend here
    .then((res) => {
